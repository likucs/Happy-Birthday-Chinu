...
const config = {
    name: "Chinu", // actual name of the recipient (Mandatory)

    nickname: "Bff", // nickname(optional)

    pic: "https://telegra.ph/file/08da0f54d195f297365ba.jpg", //image url of recipients (Mandatory)
